...
const Banner = () => {
  return (
    <div className="px-3 py-4">
      <div className="bg-linear-to-r from-[#023576] from-30% to-[#549ba7] to-120% flex items-start justify-start lg:items-center lg:justify-center pt-24 md:px-6 xl:px-24 rounded-3xl *:px-3">
        <div className="text-white py-10 flex flex-col items-start justify-start">
          <h1 className="font-black text-[32px] lg:text-[40px] lg:pr-24 leading-tight py-2 max-md:px-4">
            Desktop as a Service
            <br />
            (DaaS) Hosting Solution
          </h1>
          <p className="lg:text-lg py-4 max-md:pl-4">
            Access Your Secure & Reliable Cloud DaaS
            <br />
            Infrastructure{" "}
        ...
        <Image
          className="object-contain h-[400px] max-lg:hidden"
          src={BannerImage}
          alt="bannerImage"
        />
      </div>
